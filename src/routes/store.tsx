...
export const Route = createFileRoute("/store")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Useful Notion templates for planning, organisation, projects, and focused work." },
      { property: "og:title", content: "Store — ChronoSquares" },
      { property: "og:description", content: "Useful Notion templates for planning, organisation, projects, and focused work." },
    ],
  }),
  component: StorePage,
});
      ...
      <section className="hero-mesh">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 text-center">
          ...
          <p className="mt-4 text-muted-foreground max-w-xl mx-auto">
             Useful Notion templates for planning, organisation, projects, and focused work.
          </p>
        </div>
      </section>
