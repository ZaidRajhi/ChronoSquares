...
export const Route = createFileRoute("/chronoblog/")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Practical thinking about client onboarding, service delivery, and operational design." },
      { property: "og:title", content: "ChronoBlog — ChronoSquares" },
      { property: "og:description", content: "Practical thinking about client onboarding, service delivery, and operational design." },
    ],
  }),
  component: BlogIndex,
});
    ...
    <PublicShell>
      <section className="hero-mesh">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 text-center">
          ...
          <p className="mt-4 text-muted-foreground">Practical thinking about client onboarding, service delivery, and operational design.</p>
        </div>
      </section>
