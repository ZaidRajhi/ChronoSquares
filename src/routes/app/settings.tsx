...
import { ThemesPicker } from "@/components/app/ThemesPicker";
...
function SettingsPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-10">
      ...
      <section>
        <h2 className="text-sm font-semibold uppercase tracking-wider text-muted-foreground mb-4">Delivery workspace</h2>
        <div className="p-5 border border-border rounded-xl bg-card/40">
          <p className="text-sm">Your workspace is organised around onboarding, project delivery, communication, finance, and files.</p>
          <p className="text-xs text-muted-foreground mt-1">Lead and Care are reserved for a later release. Platform administration remains available to platform admins only.</p>
        </div>
      </section>
    </div>
  );
